					...
					<div class="foot_c">
						<div class="foot_ct">
							<div class="foot_cti">
								<div class="foot_logo">
									<div><?=$site['name']?></div>
									<p>Бізбен өз онлайн мектебіңді аш!</p>
								</div>
							</div>
							<div class="foot_cti"></div>
							<div class="foot_cti">
						...
						<div class="foot_cb">
							<div class="foot_sos">
								<? if ($site['instagram']): ?><a target="_blank" href="https://www.instagram.com/<?=$site['instagram']?>"><i class="fab fa-instagram"></i></a><? endif ?>
								<? if ($site['youtube']): ?><a target="_blank" href="#"><i class="fab fa-youtube"></i></a><? endif ?>
								<? if ($site['whatsapp']): ?><a target="_blank" href="https://wa.me/<?=$site['whatsapp']?>"><i class="fab fa-whatsapp"></i></a><? endif ?>
								<? if ($site['telegram']): ?><a target="_blank" href="#"><i class="fab fa-telegram"></i></a><? endif ?>
							</div>
						</div>
					</div>
				<? endif ?>
