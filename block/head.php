...
<!-- icon -->
<link rel="icon" href="/assets/img/logo/lg.jpg" type="image/x-icon">
<link rel="shortcut icon" type="image/icon" href="/assets/img/logo/lg.jpg">
...
<meta property="og:image" content="/assets/img/logo/lg.jpg" />
...
<? if ($site_set['swiper'] == true): ?><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/Swiper/6.4.5/swiper-bundle.min.css" /><? endif ?>
...
<? if ($site_set['swiper'] == true): ?><script src="https://cdnjs.cloudflare.com/ajax/libs/Swiper/6.4.5/swiper-bundle.min.js"></script><? endif ?>
